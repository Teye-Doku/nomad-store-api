...
//security group for instance in asg
...
resource "aws_launch_configuration" "nomad_lc" {
  name = "nomad_prefix"
  image_id = data.aws_ami.nomad-ami.image_id
...
resource "aws_autoscaling_group" "example" {
  launch_configuration = "${aws_launch_configuration.nomad_lc.name}-asg"
...
resource "aws_lb_listener" "https" {
  load_balancer_arn =  aws_lb.courage-lb.arn
...
//loadbalancer listener and redirect to https
...
# iam policy for each ec2-instance
